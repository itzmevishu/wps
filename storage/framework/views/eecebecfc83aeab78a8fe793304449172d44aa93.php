...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row"  style="padding-top:25px;">
        <div class="col-md-12" style="">
            ...
            <p>
                <?php echo Html::link('/downloadPDF/'.$orderInfo['id'], 'Download Order', array('class'=>'btn btn-primary btn-md','style'=>"margin-right:0px;")); ?>
            ...
            <div class="col-md-12 well">
                ...
                <?php foreach($orderDetailInfo as $itemDetail): ?>
                    <div class="row spacer">
                        ...
                        <div class="col-md-3">
                            $<?php echo e(number_format($courseTotal, 2)); ?>
                ...
                <?php foreach($promoDetails as $promoDetail): ?>
                    <div class="row spacer">
                        ...
                        <div class="col-md-3"> -$<?php echo e(number_format($promoDetail->promo_amt, 2)); ?></div>
                    </div>
                <?php endforeach; ?>
                <div class="row spacer">
                    ...
                    <div class="col-md-3">
                        $<?php echo e(number_format($orderInfo['order_total'], 2)); ?>
