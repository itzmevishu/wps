<?php $__env->startSection('content'); ?>
    ...
    <div class="row" style="padding-top:10px;">
        ...
        <div class="col-md-8" style="border-left:#cccccc 1px solid;">
            ...
            <?php echo e(Form::open(['url' => env('APP_URL').'/preview-checkout', 'id' => "bt-hsf-checkout-form", 'method' => 'post'])); ?>
            ...
            <div class="well" style="padding:20px 20px;">
                ...
                <div class="spacer row">
                    ...
                    -->
                    <div class="col-md-6">
                        <?php echo e(Form::label('card-number','Card Number')); ?>&nbsp;&nbsp;<span class="text-muted small">(required)</span><br>
                ...
                <div class="spacer row">
                    <div class="col-md-4">
                        <?php echo e(Form::label('expiration-date','Expiration Number')); ?>&nbsp;&nbsp;<span class="text-muted small">(required)</span><br>
                        <div class="hosted-field" id="expiration-date"></div>
                        <div class="errors"><?php echo e($errors->first('exp_month')); ?></div>
                    </div>
                    <div class="col-md-4">
                        <?php echo e(Form::label('cvv','CVV')); ?>&nbsp;&nbsp;<span class="text-muted small">(required)</span><br>
