    ...
    <div class="row" style="background-color: #fff;padding-top: 5px;padding-bottom: 25px;padding-left: 25px;padding-right: 25px;">
        ...
        <?php else: ?>
            <?php foreach($courses as $course): ?>
                ...
                <?php 
                    $imageName = str_replace('/', '', $course['image']); 
                    //$imageName2 = $imageName.'.png';

                    $image_file = '';

                    if (File::exists($course['image'].'png'))
                    {
                        $image_file = '/images/courses/'.$course['image'].'png';
                    }elseif (File::exists($course['image'].'jpg')) {
                        $image_file = '/images/courses/'.$course['image'].'jpg';
                    }else{
                ...
                <div class="col-sm-3 spacer" style="border-bottom: 1px solid #ccc;padding-top:10px;">
                    <div style="position: relative">
                        <a href="/confirm-course?courseid=<?php echo e($course['lms_course_id']); ?>" style="text-decoration:none;">
                        <?php if($course['litmos_price'] == 0): ?>
                            <div><div class="ribbon-wrapper-green"><div class="ribbon-green">FREE</div></div><img src="<?php echo e($image_file); ?>" style="width:100%"></div>
                        <?php else: ?>
                            <div><img src="<?php echo e($image_file); ?>" style="width:100%"></div>
                        <?php endif; ?>

                        <div style="min-height:60px;"><h4><?php echo e($course['litmos_title']); ?></h4></div>
                        </a>
                        <div style="min-height:50px;left: 15px;right: 15px;">
                        <a href="/confirm-course?courseid=<?php echo e($course['litmos_id']); ?>" class="btn btn-primary pull-left">View Details</a>
