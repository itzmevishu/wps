...
@section('content')
        ...
        <div class="col-md-6" >
            ...
            <div class="row spacer">
                <div class="col-md-12">
                    ...
                    {{Form::text('provider_company',isset($profile->provider_name)?$profile->provider_name:'',['class'=>'form-control','maxlength'=>'100','autocomplete'=>'off','tabindex'=>6])}}
    ...
    <div class="col-md-6" >
        ...
        <div class="row spacer">
            <div class="col-md-12">
                ...
                {{Form::text('national_provider_identifier',isset($profile->npi)?$profile->npi:'',['class'=>'form-control','maxlength'=>'10','autocomplete'=>'off','tabindex'=>13])}}
        ...
        <div class="row spacer">
            <div class="col-md-12">
                ...
                {{Form::select('part_a_or_part_b_provider',array('' => 'Please Select an Option')+wpsProviderAB(),isset($custom_fields[1])?$custom_fields[1]:'',['class'=>'form-control','tabindex'=>15])}}
        ...
        <div class="row spacer">
            <div class="col-md-12">
                ...
                {{Form::select('primary_facility_or_provider_type',array('' => 'Please Select an Option')+wpsFacilityProvider() ,isset($custom_fields[2])?$custom_fields[2]:'',['class'=>'form-control','tabindex'=>17])}}
        ...
        <div class="row spacer">
            <div class="col-md-12">
                ...
                {{Form::select('custom_7',array('' => 'Please Select an Option')+wpsFacilityProvider(), isset($custom_fields[3])?$custom_fields[3]:'', ['class'=>'form-control','tabindex'=>19])}}
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6" >
        <div class="row spacer">
            <div class="col-md-12">
                ...
                {{Form::text('provider_transaction_access_number',isset($profile->ptan)?$profile->ptan:'',['class'=>'form-control','maxlength'=>'100','autocomplete'=>'off','tabindex'=>14])}}
        ...
        <div class="row spacer">
            <div class="col-md-12">
                ...
                {{Form::select('MAC_jurisdiction',array('' => 'Please Select an Option')+wpsMACJurisdiction(), isset($custom_fields[4])?$custom_fields[4]:'', ['class'=>'form-control','tabindex'=>16])}}
        ...
        <div class="row spacer">
            <div class="col-md-12">
                ...
                {{Form::select('custom_6',array('' => 'Please Select an Option')+wpsFacilityProvider(), isset($custom_fields[5])?$custom_fields[5]:'',['class'=>'form-control','tabindex'=>18])}}
            </div>
        </div>
        ...
        <div class="row spacer">
            <div class="col-md-12">
                ...
                {{Form::select('custom_8',array('' => 'Please Select an Option')+wpsSpecialtyCodes() , isset($custom_fields[6])?$custom_fields[6]:'', ['class'=>'form-control','tabindex'=>20])}}
            </div>
        </div>
    </div>
    <div class="col-md-12">
    ...
    <div class="row spacer">
            ...
            <div class="pull-right">
                {{ Form::submit('Update',['class'=>'btn btn-primary btn-lg','tabindex'=>23]) }}
            </div>
